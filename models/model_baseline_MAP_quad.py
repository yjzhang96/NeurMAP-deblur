...
class DeblurNet():
    def __init__(self, config):
        ...
        self.blur_net = networks.define_blur(input_nc=3, output_nc=3, offset_num=15, gpu_ids=config['gpu'])      # deformable
    ...
    def update_M(self,warmup=False):
        ...
        # lambda_tv = 0.002
        tv_loss = self.L1loss(mmap_real_B_norm[:,:,:,:-1],mmap_real_B_norm[:,:,:,1:]) + \
