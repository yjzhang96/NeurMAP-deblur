...
class DeblurNet():
    ...
    def update_D(self,warmup=False):
        ...
        if self.config['train']['relative_reblur']:
            ...
            # self.fake_B_from_S , offsets = self.blur_net(self.real_S, bmap_rB_rS)
        ...
        # loss_MSE_S = self.MSE(self.fake_B_from_S,self.real_B)
        self.loss_MSE =  loss_MSE_fS

        # SSIM loss
        lambda_SSIM = 0.1
        ssim_loss_fS = 1 - self.SSIMloss.get_loss(self.fake_B_from_fS,self.real_B)
        # ssim_loss_S = 1 - self.SSIMloss.get_loss(self.fake_B_from_S,self.real_B)
    ...
    def update_G(self,warmup=False):
        ...
        self.loss_content = self.MSE(self.real_S, self.fake_S)            
        ...
        loss_G =  lambda_G_content * self.loss_content + self.loss_adv_G  \
    ...
    def get_tensorboard_images(self):
        ...
        return paired_train_img, bmap_vis
